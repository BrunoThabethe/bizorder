      ...
      <div className="container relative mx-auto px-4">
        <div className="grid items-center gap-16 lg:grid-cols-[1.1fr_1fr]">
          <div className="animate-slide-up">
            <span className="inline-flex items-center gap-2 rounded-full bg-foreground/5 px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-muted-foreground">
              <span className="grid h-1.5 w-1.5 place-items-center rounded-full bg-foreground animate-pulse" />
              Trusted by 1,200+ businesses
            </span>

            <h1 className="mt-6 font-display text-5xl font-bold leading-[1.05] md:text-6xl lg:text-7xl">
              No website?<br />
              <span className="text-foreground/60">No sales.</span><br />
          ...
          <div className="relative flex items-center justify-center animate-fade-in">
            ...
            <div className="absolute left-0 top-4 rounded-2xl bg-background/50 px-5 py-4 backdrop-blur-md ring-1 ring-foreground/10">
              <p className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground">New order</p>
              <p className="mt-1 font-display text-2xl font-bold text-foreground">+R 1,240</p>
              <p className="mt-0.5 text-[10px] text-muted-foreground">2 minutes ago</p>
            </div>

            <div className="absolute bottom-4 right-0 rounded-2xl bg-background/50 px-5 py-4 backdrop-blur-md ring-1 ring-foreground/10">
              <p className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground">Conversion</p>
              <p className="mt-1 font-display text-2xl font-bold text-foreground">↑ 218%</p>
